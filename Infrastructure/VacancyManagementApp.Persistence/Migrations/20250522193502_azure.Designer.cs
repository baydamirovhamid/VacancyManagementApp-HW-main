...
namespace VacancyManagementApp.Persistence.Migrations
{
    ...
    [Migration("20250522193502_azure")]
    partial class azure
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VacancyManagementApp.Domain.Entities.Answer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("VacancyManagementApp.Domain.Entities.Identity.AppRole", b =>
                {
            ...
            modelBuilder.Entity("VacancyManagementApp.Domain.Entities.Identity.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("VacancyManagementApp.Domain.Entities.Result", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VacancyManagementApp.Domain.Entities.Vacancy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("VacancyManagementApp.Domain.Entities.Identity.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("VacancyManagementApp.Domain.Entities.Identity.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VacancyManagementApp.Domain.Entities.Answer", b =>
                {
                    b.HasOne("VacancyManagementApp.Domain.Entities.Question", "Question")
                        .WithMany("Answers")
