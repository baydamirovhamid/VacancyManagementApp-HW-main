...
{
    public class FileUploadWriteRepository : WriteRepository<UploadedFile>, IFileUploadWriteRepository
    {
        public FileUploadWriteRepository(AppDbContext context) : base(context)
        {
        }
    }
}
