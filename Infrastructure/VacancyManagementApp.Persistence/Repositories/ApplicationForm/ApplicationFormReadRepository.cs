...
{
    public class ApplicationFormReadRepository : ReadRepository<ApplicationForm>, IApplicationFormReadRepository
    {
        public ApplicationFormReadRepository(AppDbContext context) : base(context)
        {
        }
    }
}
